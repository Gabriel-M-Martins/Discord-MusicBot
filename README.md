...
Currently the commands prefix is the forward-slash character (/). To change it go to line 18 in [main.py](Discord-MusicBot/main.py) and change the forward-slash in it. `bot = commands.Bot(command_prefix='/')`
